   ...
   header("Location: logout.php");
    exit();
         ...
         $deptid=$_SESSION['deptid'];
                      ...
                      $cl=$rowc['crq'];
                      $sql="select count(*) as crq from tbl_hodrecommendation where status ='0'";
                      $cql=$conn->query($sql);
                      $rowc=$cql->fetch_assoc();
                      $pl=$rowc['crq'];
               ...
               <div class="sidebar-menu">
                  <ul class="menu">
                     ...
                     <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                          <li>
                             <a href="dpending_leave.php">Pending Leave Requests</a>
                          </li>
                           <li>
                              <a href="dall_leave.php">All Leaves</a>
                           </li>
              ...
              <div class="card-body">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    ...
                    <div>
                      <h4>Canceled Leaves Requests</h4>
                    <h2 class="h1 mb-0"><?php echo $cl ?></h2>
                    </div>
                  </div>
                </div>
