...
if(isset($_POST['cancel'])){
    $reqid=$_POST['req_id'];
    $sql="update tbl_leave set status='3' where req_id='$reqid'";
    $conn->query($sql);
    header("Location:cancel_leave.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    <?php  
                                    $sql="SELECT * FROM tbl_leave WHERE emp_id = $empid and status = '0'";
                                    ...
                                    if ($result){
                                        ...
                                        <input type='submit' value='Cancel' name='cancel' class='btn btn-primary float-end'>
                                        </form>
                                        </td>";
                                            echo"</tr>";
                                            }
